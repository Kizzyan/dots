# Generated by Powerlevel10k configuration wizard on 2024-05-12 at 17:37 -03.
...
# angled separators, round heads, round tails, 2 lines, dotted, left frame,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=4 # 4
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=0 # 0
  # Custom icon.
